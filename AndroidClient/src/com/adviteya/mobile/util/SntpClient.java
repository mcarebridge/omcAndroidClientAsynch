...
public class SntpClient
{
	 ...
	 */
	public boolean requestTime(String host, int timeout) throws NTPTimeoutException
	{
		try
		{
			...
			Log.i(TAG, "Reference Time :: " + sdf1.format(new Date(receiveTime)));
		...
		} catch (Exception e)
		{
			...
			throw new NTPTimeoutException(e);
		}
